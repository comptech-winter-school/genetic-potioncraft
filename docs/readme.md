...
На портале представлен комплект документации проекта «<Название проекта>» для оценки работы технического писателя 'Новиковой Валентины Евгеньевны', а именно артефакты:
